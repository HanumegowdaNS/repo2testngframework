...
public class WorkItemNamesPaginationFilters {
	WorkItemNamesPage workItemNamesPage = new WorkItemNamesPage();
	   ...
	   // phase id equals 
		...
		public void organizations_Pagination_PhaseIdEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("id", "Equals","Phase_Id", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNamePhaseAttributes("id","Equals", 0);
		...
		public void organizations_Pagination_PhaseIdNotEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("id", "Not Equals","Phase_Id", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
     		workItemNamesPage.verifyWorkItemNamePhaseAttributes("id","Not Equals", 0);
		...
		public void organizations_Pagination_PhaseNameEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Equals","Phase_name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNamePhaseAttributes("name","Equals", 1);
	        APIListener.addLogger("WorkItemNames Phase attribute 'Id' fetching value for Equals operator successfully!");
		}	
		...
		public void organizations_Pagination_PhaseNameNotEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Not Equals","Phase_name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNamePhaseAttributes("name","Not Equals", 1);
	        APIListener.addLogger("WorkItemNames Phase attribute 'Id' fetching value for Not Equals operator successfully!");
		}	
		...
		public void organizations_Pagination_PhaseNameContains() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Contains","Phase_name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNamePhaseAttributes("name","Contains", 1);
		...
		public void organizations_Pagination_PhaseNameNotContains() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Not Contains","Phase_name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesPhases_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNamePhaseAttributes("name","Not Contains", 1);
		...
		public void organizations_Pagination_GateIdEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("id", "Equals","Gate_Id", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("id","Equals", 0);
		...
		public void organizations_Pagination_GateIdNotEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("id", "Not Equals","Gate_Id", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("id","Not Equals", 0);
		...
		public void organizations_Pagination_GateNameEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Equals","Gate_Name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("name","Equals", 1);
		...
		public void organizations_Pagination_GateNameNotEquals() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Not Equals","Gate_Name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("name","Not Equals", 1);
		...
		public void organizations_Pagination_GateNameContains() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Contains","Gate_Name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("name","Contains", 1);
		...
		public void organizations_Pagination_GateNameNotContains() throws ParseException, InterruptedException {
			...
			workItemNamesPage.paginationfilter(PlutoraAPIConfiguration.testData,workItemNamesPage.setPaginationFilterOperator("name", "Not Contains","Gate_Name", PlutoraAPIConfiguration.testData),
						"0", "10", "WorkItemNamesGates_PaginationFilterURL");
			workItemNamesPage.verifyWorkItemNameGateAttributes("name","Not Contains", 1);
