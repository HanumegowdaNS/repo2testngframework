...
public class TEBRPaginationFilterWithoutPageNum {
	...
	public void getTebrs_Pagination_IdEquals() throws ParseException, InterruptedException {
		...
		tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("id", "Equals","TEBR_Id", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
		tebrPage.setDataToPropertysWithoutPage("id");
		tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","TEBR_Id",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void getTebrs_Pagination_IdNotEquals() throws ParseException, InterruptedException {
		...
		tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("id", "Not Equals","TEBR_Id", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
		tebrPage.setDataToPropertysWithoutPage("id");
		tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","TEBR_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_NumberEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("number", "Equals","TEBR_number", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("number");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("number","TEBR_number",PlutoraAPIConfiguration.testData,"Equals");
	...
	//numeber not equals 
		...
		public void getTebrs_Pagination_NumberNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("number", "Not Equals","TEBR_number", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("number");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("number","TEBR_number",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_NumberContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("number", "Contains","TEBR_number", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("number");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("number","TEBR_number",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_NumberNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("number", "Not Contains","TEBR_number", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("number");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("number","TEBR_number",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void getTebrs_Pagination_titleEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("title", "Equals","TEBR_title", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("title");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("title","TEBR_title",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_titleNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("title", "Not Equals","TEBR_title", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("title");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("title","TEBR_title",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_titleContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("title", "Contains","TEBR_title", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("title");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("title","TEBR_title",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_titleNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("title", "Not Contains","TEBR_title", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("title");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("title","TEBR_title",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void getTebrs_Pagination_releaseNameEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("releaseName", "Equals","releaseName", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("releaseName");
			tebrPage.verifyResponseArrayValueForPaginationTECRWithoutPageNum("releaseName","releaseName",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_releaseNameNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("releaseName", "Not Equals","releaseName", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("releaseName");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseName","releaseName",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_releaseNameContains() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("releaseName", "Contains","releaseName", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("releaseName");
			tebrPage.verifyResponseArrayValueForPaginationTECRWithoutPageNum("releaseName","releaseName",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_releaseNameNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("releaseName", "Not Contains","releaseName", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("releaseName");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseName","releaseName",PlutoraAPIConfiguration.testData,"Not Contains");
	   ...
	   //start date equals
		...
		public void getTebrs_Pagination_startDateEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Equals","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Equals");
       ...
       //start date not equals
		...
		public void getTebrs_Pagination_startDateNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Not Equals","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_startDateGreaterThan() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Greater Than","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Greater Than");
		...
		public void getTebrs_Pagination_startDateGreaterorequal() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Greater Or Equal","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
		...
		public void getTebrs_Pagination_startDatelessthan() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Less Than","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Less Than");
		...
		public void getTebrs_Pagination_startDateLessOrEqual() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("startDate", "Less Or Equal","split_startdate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("startDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("startDate","split_startdate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		...
		public void getTebrs_Pagination_endDateEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Equals","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_endDateNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Not Equals","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void GetTebrs_Pagination_endDateLessThan() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Less Than","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Less Than");
		...
		public void getTebrs_Pagination_endDateLessOrEqual() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Less Or Equal","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		...
		public void getTebrs_Pagination_endDateGreaterThan() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Greater Than","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Greater Than");
		...
		public void getTebrs_Pagination_endDateGreaterOrEqual() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("endDate", "Greater Or Equal","split_enddate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("endDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("endDate","split_enddate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
	...
	//assignedTo equals
		...
		public void getTebrs_Pagination_AssignedToEquals() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("assignedTo", "Equals","assignedTo", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("assignedTo");
			tebrPage.verifyResponseArrayValueForPaginationTECRWithoutPageNum("assignedTo","assignedTo",PlutoraAPIConfiguration.testData,"Equals");
      ...
      //assignedTo not equals
		...
		public void getTebrs_Pagination_AssignedToNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("assignedTo", "Not Equals","assignedTo", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("assignedTo");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assignedTo",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_AssignedToContains() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("assignedTo", "Contains","assignedTo", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("assignedTo");
			tebrPage.verifyResponseArrayValueForPaginationTECRWithoutPageNum("assignedTo","assignedTo",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_AssignedToNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.getTEBR(PlutoraAPIConfiguration.testData);
			tebrPage.getAndSetJsonData(PlutoraAPIConfiguration.testData,PropertiesCache.getProperty(PlutoraAPIConfiguration.testData, "TEBRParametersAttributes"));	
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("assignedTo", "Not Contains","assignedTo", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("assignedTo");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assignedTo",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void getTebrs_Pagination_descriptionEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("description", "Equals","TEBR_description", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("description");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","TEBR_description",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_descriptionNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("description", "Not Equals","TEBR_description", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("description");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","TEBR_description",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_descriptionContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("description", "Contains","TEBR_description", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("description");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","TEBR_description",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_descriptionNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("description", "Not Contains","TEBR_description", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("description");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","TEBR_description",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void getTebrs_Pagination_statusIdEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("statusID", "Equals","TEBR_statusID", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("statusID");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("statusID","TEBR_statusID",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_statusIdNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("statusID", "Not Equals","TEBR_statusID", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("statusID");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("statusID","TEBR_statusID",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_statusEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("status", "Equals","TEBR_status", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("status");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","TEBR_status",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_statusNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("status", "Not Equals","TEBR_status", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("status");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","TEBR_status",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_statusContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("status", "Contains","TEBR_status", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("status");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","TEBR_status",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_statusNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("status", "Not Contains","TEBR_status", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("status");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","TEBR_status",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void getTebrs_Pagination_TypeEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("type", "Equals","TEBR_type", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("type");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("type","TEBR_type",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void getTebrs_Pagination_TypeNotEquals() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("type", "Not Equals","TEBR_type", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("type");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("type","TEBR_type",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void getTebrs_Pagination_TypeContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("type", "Contains","TEBR_type", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("type");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("type","TEBR_type",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void getTebrs_Pagination_TypeNotContains() throws ParseException, InterruptedException {
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("type", "Not Contains","TEBR_type", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("type");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("type","TEBR_type",PlutoraAPIConfiguration.testData,"Not Contains");
		  ...
		  String[] lastModified_date;
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Equals","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Equals");
		  ...
		  //last Modified date not equals
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Not Equals","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Not Equals");
		  ...
		  //last Modified date greater than
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Greater Than","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Than");
		  ...
		  //last Modified date greater or equal
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Greater Or Equal","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
		  ...
		  //last Modified dat less than
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Less Than","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Than");
		  ...
		  //last Modified date less or equal
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedDate", "Less Or Equal","split_lastModifiedDate", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedDate");
			tebrPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		  ...
		  //last Modified by equals
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedBy", "Equals","TEBR_lastModifiedBy", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedBy");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","TEBR_lastModifiedBy",PlutoraAPIConfiguration.testData,"Equals");
		  ...
		  //last Modified by not equals
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedBy", "Not Equals","TEBR_lastModifiedBy", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedBy");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","TEBR_lastModifiedBy",PlutoraAPIConfiguration.testData,"Not Equals");
		  ...
		  //last Modified by contains
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedBy", "Contains","TEBR_lastModifiedBy", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedBy");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","TEBR_lastModifiedBy",PlutoraAPIConfiguration.testData,"Contains");
		  ...
		  //last Modified by Not Contains
			...
			tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterOperator("lastModifiedBy", "Not Contains","TEBR_lastModifiedBy", PlutoraAPIConfiguration.testData),"GET_TEBRs_PaginationFiltersURL");
			tebrPage.setDataToPropertysWithoutPage("lastModifiedBy");
			tebrPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","TEBR_lastModifiedBy",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	public void GetTebrs_releaseName_Combination1() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_releaseName_Id1");
		tebrPage.setDataToPropertysWithoutPage("releaseName", "ReleaseName_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_releaseName_Id2");
		tebrPage.setDataToPropertysWithoutPage("releaseName", "ReleaseName_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		// Release name contains ( A OR B )
		tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData,
	...
	public void GetTebrs_releaseName_Combination2() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_status_Id1");
		tebrPage.setDataToPropertysWithoutPage("status", "status_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_status_Id2");
		tebrPage.setDataToPropertysWithoutPage("status", "status_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		// Status equals ( X OR Y )
		tebrPage.paginationfilterWithoutPagenum(
	...
	public void GetTebrs_Pagination_AssignedTo_Combination1() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_AssignedTo_Id1");
		tebrPage.setDataToPropertysWithoutPage("assignedTo", "AssignedTo_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_AssignedTo_Id2");
		tebrPage.setDataToPropertysWithoutPage("assignedTo", "AssignedTo_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
	...
	public void GetTebrs_Pagination_Requester_Combination2() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Requester_Id1");
		tebrPage.setDataToPropertysWithoutPage("assignedTo", "Requester_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Requester_Id2");
		tebrPage.setDataToPropertysWithoutPage("assignedTo", "Requester_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
	...
	public void GetTebrs_Pagination_StartDate_Combination1() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_StartDate_Id1");
		tebrPage.setDataToPropertysWithoutPage("startDate", "StartDate_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_StartDate_Id2");
		tebrPage.setDataToPropertysWithoutPage("startDate", "StartDate_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
	...
	public void GetTebrs_Pagination_EndDate_Combination2() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_EndDate_Id1");
		tebrPage.setDataToPropertysWithoutPage("endDate", "EndDate_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_EndDate_Id2");
		tebrPage.setDataToPropertysWithoutPage("endDate", "EndDate_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
	...
	public void GetTebrs_Pagination_Number_Combination1() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Number_Id1");
		tebrPage.setDataToPropertysWithoutPage("number", "Number_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Number_Id2");
		tebrPage.setDataToPropertysWithoutPage("number", "Number_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
	...
	public void GetTebrs_Pagination_Type_Combination3() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Type_Id1");
		tebrPage.setDataToPropertysWithoutPage("type", "Type_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_Type_Id2");
		tebrPage.setDataToPropertysWithoutPage("type", "Type_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		// Status Equals (x or y)
		tebrPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, tebrPage.setPaginationFilterCombinations("type",
	...
	public void GetTebrs_Pagination_RaisedDate_Combination3() throws ParseException, InterruptedException {
		...
		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_RaisedDate_Id1");
		tebrPage.setDataToPropertysWithoutPage("raisedDate", "RaisedDate_1");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		tebrPage.createTEBR("createTEBR4265Json", PlutoraAPIConfiguration.testData);
		tebrPage.setDataToPropertysWithoutPage("id", "Tebrs_RaisedDate_Id2");
		tebrPage.setDataToPropertysWithoutPage("raisedDate", "RaisedDate_2");
		tebrPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
