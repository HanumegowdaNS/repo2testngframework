...
import com.plutoraapi.pagerepo.UsersPage;
 ...
 public class UsersPaginationFilters {
	...
	public void getUsersFields_Pagination_idEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("id", "Equals","userid", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl"); 
		usersPage.verifyusersAttributes("id","Equals", 0);
	...
	public void getUsersFields_Pagination_idNotEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("id", "Not Equals","userid", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("id","Not Equals", 0);
	...
	public void getUsersFields_Pagination_firstNameEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("firstName", "Equals","userFirstName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("firstName","Equals", 1);
	...
	public void getUsersFields_Pagination_firstNameNotEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("firstName", "Not Equals","userFirstName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("firstName","Not Equals", 1);
	...
	public void GetUsersFields_Pagination_firstNameContains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("firstName", "Contains","userFirstName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("firstName","Contains", 1);
	...
	public void getUsersFields_Pagination_firstNameNotContains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("firstName", "Not Contains","userFirstName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("firstName","Not Contains", 1);
	...
	public void getUsersFields_Pagination_lastNameEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("lastName", "Equals","userLastName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("lastName","Equals", 2);
	...
	//lastname not equals
	 ...
	 public void getUsersFields_Pagination_lastNameNotEquals() throws ParseException, InterruptedException {
		APIListener.addLogger("[API] - Users attribute 'lastName' fetching value for Equals operator");
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("lastName", "Not Equals","userLastName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("lastName","Not Equals", 2);
    ...
    //lastname Contains
	  ...
	  public void getUsersFields_Pagination_lastNamecontains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("lastName", "Contains","userLastName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("lastName","Contains", 2);
	...
	//lastname not Contains
	 ...
	 public void getUsersFields_Pagination_lastNameNotContains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("lastName", "Not Contains","userLastName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("lastName","Not Contains", 2);
	 ...
	 public void getUsersFields_Pagination_userNameEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("userName", "Equals","usersUserName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("userName","Equals", 3);
   ...
   //username not equals
	 ...
	 public void getUsersFields_Pagination_userNameNotEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("userName", "Not Equals","usersUserName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("userName","Not Equals", 3);
    ...
    //username contains
	 ...
	 public void getUsersFields_Pagination_userNameContains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("userName", "Contains","usersUserName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("userName","Contains", 3);
	...
	//username not Contains
	 ...
	 public void getUsersFields_Pagination_userNameNotContains() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("userName", "Not Contains","usersUserName", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("userName","Not Contains", 3);
	 ...
	 public void getUsersFields_Pagination_statusEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("status", "Equals","users_status", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("status","Equals", 4);
    ...
    //status not equals
	 ...
	 public void getUsersFields_Pagination_statusNotEquals() throws ParseException, InterruptedException {
		...
		usersPage.paginationfilter(PlutoraAPIConfiguration.testData,usersPage.setPaginationFilterOperator("status", "Not Equals","users_status", PlutoraAPIConfiguration.testData),
				"0", "10", "users_PaginationFilterUrl");
		usersPage.verifyusersAttributes("status","Not Equals", 4);
