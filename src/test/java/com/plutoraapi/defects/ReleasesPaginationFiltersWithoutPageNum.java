...
public class ReleasesPaginationFiltersWithoutPageNum {
	...
	public void releasesPagination_IdEquals() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("id", "Equals", "release_Id", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("id");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","release_Id",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void releasesPagination_IdNotEquals() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("id", "Not Equals", "release_Id", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("id");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","release_Id",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void releasesPagination_identifierEquals() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("identifier", "Equals", "release_identifier", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("identifier");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("identifier","release_identifier",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void releasesPagination_identifierNotEquals() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("identifier", "Not Equals", "release_identifier", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("identifier");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("identifier","release_identifier",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void releasesPagination_identifierContains() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("identifier", "Contains", "release_identifier", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("identifier");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("identifier","release_identifier",PlutoraAPIConfiguration.testData,"Contains");
	...
	public void releasesPagination_identifierNotContains() throws ParseException, InterruptedException{
		...
		releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("identifier", "Not Contains", "release_identifier", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("identifier");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("identifier","release_identifier",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	public void releasesPagination_nameEquals() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("name", "Equals", "release_name", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("name");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","release_name",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void releasesPagination_nameNotEquals() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("name", "Not Equals", "release_name", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("name");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","release_name",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void releasesPagination_nameContains() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("name", "Contains", "release_name", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("name");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","release_name",PlutoraAPIConfiguration.testData,"Contains");
	...
	public void releasesPagination_nameNotContains() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("name", "Not Contains", "release_name", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("name");
		releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","release_name",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	public void releasesPagination_implementationDateEquals() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Equals", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("implementationDate");
		releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void releasesPagination_implementationDateNotEquals() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Not Equals", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("implementationDate");
		releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void releasesPagination_implementationDateGreaterThan() throws ParseException, InterruptedException{
	    ...
	    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Greater Than", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
		releasesPage.setDataToPropertysWithoutPage("implementationDate");
		releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Greater Than");
	...
	//implementationDate greater or equal
		...
		public void releasesPagination_implementationDateGreaterOrEqual() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Greater Or Equal", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("implementationDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
		...
		public void releasesPagination_implementationDateLessThan() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Less Than", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("implementationDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Less Than");
		...
		public void releasesPagination_implementationDateLessOrEqual() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("implementationDate", "Less Or Equal", "split_implementDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("implementationDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("implementationDate","split_implementDate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		...
		public void releasesPagination_displayColorEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("displayColor", "Equals", "release_color", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("displayColor");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayColor","release_color",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_displayColorNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("displayColor", "Not Equals", "release_color", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("displayColor");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayColor","release_color",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_displayColorContains() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("displayColor", "Contains", "release_color", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("displayColor");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayColor","release_color",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void releasesPagination_displayColorNotContains() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("displayColor", "Not Contains", "release_color", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("displayColor");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayColor","release_color",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void releasesPagination_plutoraReleaseTypeEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("plutoraReleaseType", "Equals", "plutora_releaseType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("plutoraReleaseType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("plutoraReleaseType","plutora_releaseType",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_plutoraReleaseTypeNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("plutoraReleaseType", "Not Equals", "plutora_releaseType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("plutoraReleaseType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("plutoraReleaseType","plutora_releaseType",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_releaseProjectTypeEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseProjectType", "Equals", "release_ProjectType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseProjectType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseProjectType","release_ProjectType",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_releaseProjectTypeNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseProjectType", "Not Equals", "release_ProjectType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseProjectType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseProjectType","release_ProjectType",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_releaseStatusTypeEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusType", "Equals", "release_statusType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusType","release_statusType",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_releaseStatusTypeNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusType", "Not Equals", "release_statusType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusType","release_statusType",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_releaseStatusTypeContains() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusType", "Contains", "release_statusType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusType","release_statusType",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void releasesPagination_releaseStatusTypeNotContains() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusType", "Not Contains", "release_statusType", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusType");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusType","release_statusType",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void releasesPagination_lastModifiedDateEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Equals", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_lastModifiedDateNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Not Equals", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_lastModifiedDateGreaterThan() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Greater Than", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Than");
		...
		public void releasesPagination_lastModifiedDateGreaterOrEqual() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Greater Or Equal", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
		...
		public void releasesPagination_lastModifiedDateLessThan() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Less Than", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Than");
		...
		public void releasesPagination_lastModifiedDateLessOrEqual() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("lastModifiedDate", "Less Or Equal", "split_lastModifiedDate", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("lastModifiedDate");
			releasesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		...
		public void releasesPagination_parentReleaseIDEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentReleaseID", "Equals", "parent_ReleaseId", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentReleaseID");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentReleaseID","parent_ReleaseId",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_parentReleaseIDNotEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Releases attribute 'parentReleaseID' fetching value for Equals operator"); 
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentReleaseID", "Not Equals", "parent_ReleaseId", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentReleaseID");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentReleaseID","parent_ReleaseId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_parentReleaseEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentRelease", "Equals", "parent_Release", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentRelease");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentRelease","parent_Release",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_parentReleaseNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentRelease", "Not Equals", "parent_Release", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentRelease");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentRelease","parent_Release",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void releasesPagination_parentReleaseContains() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentRelease", "Contains", "parent_Release", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentRelease");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentRelease","parent_Release",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void releasesPagination_parentReleaseNotContains() throws ParseException, InterruptedException{
			...
			releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("parentRelease", "Not Contains", "parent_Release", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("parentRelease");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("parentRelease","parent_Release",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void releasesPagination_releaseStatusTypeIDEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusTypeID", "Equals", "release_StatusTypeId", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusTypeID");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusTypeID","release_StatusTypeId",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void releasesPagination_releaseStatusTypeIDNotEquals() throws ParseException, InterruptedException{
		    ...
		    releasesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, releasesPage.setPaginationFilterOperator("releaseStatusTypeID", "Not Equals", "release_StatusTypeId", PlutoraAPIConfiguration.testData), "releasesPaginationFilterUrl");
			releasesPage.setDataToPropertysWithoutPage("releaseStatusTypeID");
			releasesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("releaseStatusTypeID","release_StatusTypeId",PlutoraAPIConfiguration.testData,"Not Equals");
