...
public class OrganizationsPaginationFilters {
	...
	public void organizations_Pagination_IdNotEquals() throws ParseException, InterruptedException {
		...
		organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("id", "Not Equals","Organization_Id", PlutoraAPIConfiguration.testData),
					"0", "10", "GetOrganizations_PaginationFiltersUrl");
		organizationsPage.verifyOrganizationsValue("id","Not Equals", 0);
	...
	// name equals
		...
		public void organizations_Pagination_nameEquals() throws ParseException, InterruptedException {
			...
			organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("name", "Equals","Organization_name", PlutoraAPIConfiguration.testData),
						"0", "10", "GetOrganizations_PaginationFiltersUrl");
				organizationsPage.verifyOrganizationsValue("name","Equals", 1);
		...
		public void organizations_Pagination_nameNotEquals() throws ParseException, InterruptedException {
			...
			organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("name", "Not Equals","Organization_name", PlutoraAPIConfiguration.testData),
						"0", "10", "GetOrganizations_PaginationFiltersUrl");
			organizationsPage.verifyOrganizationsValue("name","Not Equals", 1);
		...
		public void organizations_Pagination_nameContains() throws ParseException, InterruptedException {
			...
			organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("name", "Contains","Organization_name", PlutoraAPIConfiguration.testData),
						"0", "10", "GetOrganizations_PaginationFiltersUrl");
			organizationsPage.verifyOrganizationsValue("name","Contains", 1);
		...
		public void organizations_Pagination_nameNotContains() throws ParseException, InterruptedException {
			...
			organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("name", "Not Contains","Organization_name", PlutoraAPIConfiguration.testData),
						"0", "10", "GetOrganizations_PaginationFiltersUrl");
			organizationsPage.verifyOrganizationsValue("name","Not Contains", 1);
		...
		public void organizations_Pagination_typeEquals() throws ParseException, InterruptedException {
			...
			organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("type", "Equals","Organization_type", PlutoraAPIConfiguration.testData),
						"0", "10", "GetOrganizations_PaginationFiltersUrl");
			organizationsPage.verifyOrganizationsValue("type","Equals", 2);
        ...
        public void organizations_Pagination_typeNotEquals() throws ParseException, InterruptedException {
	        ...
	        organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("type", "Not Equals","Organization_type", PlutoraAPIConfiguration.testData),
				"0", "10", "GetOrganizations_PaginationFiltersUrl");
		    organizationsPage.verifyOrganizationsValue("type","Not Equals", 2);
