...
public class LookupFieldsPaginationFilters {
	...
	public void OrganizationsTree_Pagination_IdEquals() throws ParseException, InterruptedException {
		...
		organizationsPage.paginationfilter(PlutoraAPIConfiguration.testData,organizationsPage.setPaginationFilterOperator("id", "Equals","Organization_Id", PlutoraAPIConfiguration.testData),
					"0", "10", "GetOrganizations_PaginationFiltersUrl");
	...
	public void getLookupFields_Pagination_NameEquals() throws ParseException, InterruptedException {
		...
		lookupFields.paginationfilter(PlutoraAPIConfiguration.testData,lookupFields.setPaginationFilterOperator("name", "Equals","LookupName", PlutoraAPIConfiguration.testData),
				"0", "10", "LookupFields_PaginationFilterUrl");
		lookupFields.verifyLookupFieldValue("name","Equals", 0);
	...
	public void getLookupFields_Pagination_NameNotEquals() throws ParseException, InterruptedException {
		...
		lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("name", "Not Equals", "LookupName", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
		lookupFields.setDataToPropertys("name");
		lookupFields.verifyLookupFieldValueList("name","Not Equals", 0);
     ...
     //name contains
		...
		public void getLookupFields_Pagination_Namecontains() throws ParseException, InterruptedException {
			...
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("name", "Contains", "LookupName", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("name");
			lookupFields.verifyLookupFieldValue("name","Contains", 0);
		...
		public void getLookupFields_Pagination_NameNotContains() throws ParseException, InterruptedException {
			...
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("name", "Not Contains", "LookupName", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("name");
			lookupFields.verifyLookupFieldValueList("name","Not Contains", 0);
		...
		public void getLookupFields_Pagination_descriptionEquals() throws ParseException, InterruptedException {
			...
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("description", "Equals", "LookupDescription", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("description");
			lookupFields.verifyLookupFieldValue("description","Equals", 1);
		...
		public void getLookupFields_Pagination_descriptionNotEquals() throws ParseException, InterruptedException {
			...
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("description", "Not Equals", "LookupDescription", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("description");
			lookupFields.verifyLookupFieldValueList("description","Not Equals", 1);
		...
		public void getLookupFields_Pagination_descriptionContains() throws ParseException, InterruptedException {
			...
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("description", "Contains", "LookupDescription", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("description");
			lookupFields.verifyLookupFieldValue("description","Contains", 1);
		...
		public void getLookupFields_Pagination_descriptionNotContains() throws ParseException, InterruptedException {
			APIListener.addLogger("[API] - LookupFields attribute 'description' fetching value for equals operator");
			lookupFields.paginationfilter(PlutoraAPIConfiguration.testData, lookupFields.setPaginationFilterOperator("description", "Not Contains", "LookupDescription", PlutoraAPIConfiguration.testData), "0", "10","LookupFields_PaginationFilterUrl");
			lookupFields.setDataToPropertys("description");
			lookupFields.verifyLookupFieldValueList("description","Not Contains", 1);
