...
public class EnvironmentPaginationFiltersWithoutPageNum  {
	...
	EnvironmentPage environmentPage = new EnvironmentPage();
		...
		public void environmentsPagination_IdEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("id", "Equals", "Env_id", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("id");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","Env_id",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_idNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("id", "Not Equals", "Env_id", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("id");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","Env_id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_NameEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("name", "Equals", "Env_name", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("name");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","Env_name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_NameNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("name", "Not Equals", "Env_name", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("name");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","Env_name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_NameContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("name", "Contains", "Env_name", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("name");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","Env_name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_NameNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("name", "Not Contains", "Env_name", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("name");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","Env_name",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentsPagination_urlEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("url", "Equals", "Env_url", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("url");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("url","Env_url",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_urlNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("url", "Not Equals", "Env_url", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("url");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("url","Env_url",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_urlContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("url", "Contains", "Env_url", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("url");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("url","Env_url",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_urlNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("url", "Not Contains", "Env_url", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("url");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("url","Env_url",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentsPagination_linkedSystemEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("linkedSystem", "Equals", "Env_linkedSystem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("linkedSystem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("linkedSystem","Env_linkedSystem",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_linkedSystemNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("linkedSystem", "Not Equals", "Env_linkedSystem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("linkedSystem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("linkedSystem","Env_linkedSystem",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_linkedSystemContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("linkedSystem", "Contains", "Env_linkedSystem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("linkedSystem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("linkedSystem","Env_linkedSystem",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_linkedSystemNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("linkedSystem", "Not Contains", "Env_linkedSystem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("linkedSystem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("linkedSystem","Env_linkedSystem",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentsPagination_usageWorkItemEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("usageWorkItem", "Equals", "Env_usageWorkItem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("usageWorkItem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItem","Env_usageWorkItem",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_usageWorkItemNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("usageWorkItem", "Not Equals", "Env_usageWorkItem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("usageWorkItem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItem","Env_usageWorkItem",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_usageWorkItemContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("usageWorkItem", "Contains", "Env_usageWorkItem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("usageWorkItem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItem","Env_usageWorkItem",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_usageWorkItemNoContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("usageWorkItem", "Not Contains", "Env_usageWorkItem", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("usageWorkItem");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItem","Env_usageWorkItem",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentsPagination_statusEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("status", "Equals", "Env_status", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("status");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","Env_status",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_statusNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("status", "Not Equals", "Env_status", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("status");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","Env_status",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentsPagination_statusContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("status", "Contains", "Env_status", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("status");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","Env_status",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_statusNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("status", "Not Contains", "Env_status", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("status");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","Env_status",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentsPagination_colorEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("color", "Equals", "Env_Groupcolor", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("color");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Env_Groupcolor",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentsPagination_colorNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("color", "Not Equals", "Env_Groupcolor", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("color");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Env_Groupcolor",PlutoraAPIConfiguration.testData,"Not Equals");
			APIListener.addLogger("Environments Page attribute 'color' fetching value for Equals operator successfully!"); 
		}	
		...
		public void environmentsPagination_colorContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("color", "Contains", "Env_Groupcolor", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("color");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Env_Groupcolor",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentsPagination_colorNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("color", "Not Contains", "Env_Groupcolor", PlutoraAPIConfiguration.testData), "environmentsPaginationFilterUrl");
			environmentPage.setDataToPropertysWithoutPage("color");
			environmentPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Env_Groupcolor",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	/*	
	      // combination filter  name equals (a or b) and usageWorkItemName equals (x or y) 
			...
			public void environmentGroupPagination_Combinations1() throws ParseException, InterruptedException{
				...
				environmentPage.setDataToPropertysWithoutPage("name;usageWorkItemName;isSharedEnvironment;linkedSystem" ,"name_1;usageWorkItemName_1;isSharedEnvironment_1;linkedSystem_1");
				environmentPage.setDataToPropertysWithoutPage("color;environmentStatus;usageWorkItemId;linkedSystemId" ,"color_1;environmentStatus_1;usageWorkItemId_1;linkedSystemId_1");
				...
				environmentPage.setDataToPropertysWithoutPage("name;usageWorkItemName;isSharedEnvironment;linkedSystem" ,"name_2;usageWorkItemName_2;isSharedEnvironment_2;linkedSystem_2");
				environmentPage.setDataToPropertysWithoutPage("color;environmentStatus;usageWorkItemId;linkedSystemId" ,"color_2;environmentStatus_2;usageWorkItemId_2;linkedSystemId_2");
				
				// name equals (a or b) and usageWorkItemName equals (x or y) 
				environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterCombinations_1("name", "equals", "name_1","OR","name_2", "And","usageWorkItemName", "Equals","usageWorkItemName_1", "Or", "usageWorkItemName_2",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterCombinations_1("environmentIDs", "Equals", "envId_1","OR","envId_2", "Or","usageWorkItemName", "NotEquals","usageIteam_1", "Or", "usageIteam_1",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterCombinations_1("name", "Contains", "name_1","OR","name_2", "And","color", "Equals","color_1", "Or", "color_2",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
			environmentPage.verifyResponseArrayValueCombination("name",PlutoraAPIConfiguration.testData,"Contains", new String [] {"name_1","name_2"});
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterCombinations_3("displayBookingAlert", "Contains", "displayBook_1", "Or", "bookingAlertMessage", "Contains", "bookingAlertMsg_1", "Or", "bookingAlertMsg_2", PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
			...
			environmentPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterCombinations_2("name", "Equals", "name_1", "Or", "name_2", "And", "usageWorkItemName", "Equals", "usageIteam_1", "Or", "usageIteam_2", "Or", "isAutoApproved", "Equals", "isAutoApproved_1", "Or", "isAutoApproved_2", PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
