...
public class SystemsPaginationFilters  {
	...
	SystemsPage systemsPage =new SystemsPage();
		...
		public void systemsPagination_IdEquals() throws ParseException, InterruptedException{
			...
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("id","Equals","System_Id", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
			systemsPage.setDataToPropertys("id");
			systemsPage.verifyResponseArrayValueForPagination("id","System_Id",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void systemsPagination_IdNotEquals() throws ParseException, InterruptedException{
			...
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("id","Not Equals","System_Id", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
			systemsPage.setDataToPropertys("id");
			systemsPage.verifyResponseArrayValueForPagination("id","System_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void systemsPagination_nameEquals() throws ParseException, InterruptedException{
			...
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("name","Equals","System_name", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
			systemsPage.setDataToPropertys("name");
			systemsPage.verifyResponseArrayValueForPagination("name","System_name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void systemsPagination_nameNotEquals() throws ParseException, InterruptedException{
			...
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("name","Not Equals","System_name", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
		    systemsPage.setDataToPropertys("name");
		    systemsPage.verifyResponseArrayValueForPagination("name","System_name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void systemsPagination_nameContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Systems attribute 'name' fetching value for Equals operator"); 
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("name","Contains","System_name", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
			systemsPage.setDataToPropertys("name");
			systemsPage.verifyResponseArrayValueForPagination("name","System_name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void systemsPagination_nameNotContains() throws ParseException, InterruptedException{
			...
			systemsPage.paginationfilter(PlutoraAPIConfiguration.testData, systemsPage.setPaginationFilterOperator("name","Not Contains","System_name", PlutoraAPIConfiguration.testData), "0", "10","systemsPaginationFilterUrl");
			systemsPage.setDataToPropertys("name");
			systemsPage.verifyResponseArrayValueForPagination("name","System_name",PlutoraAPIConfiguration.testData,"Not Contains");
