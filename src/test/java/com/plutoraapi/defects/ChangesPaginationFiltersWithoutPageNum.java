...
public class ChangesPaginationFiltersWithoutPageNum  {
 ...
 /*
		//ID Not Equals 
			...
			public void changesPagination_IdNotEquals() throws ParseException, InterruptedException{
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("id", "Not Equals", "Change_Id", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("id");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","Change_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void changesPagination_NameEquals() throws ParseException, InterruptedException{
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("name", "Equals", "change_name", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("name");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","change_name",PlutoraAPIConfiguration.testData,"Equals");
	  ...
	  //Not Equals name
		...
		public void changesPagination_NameNotEquals() throws ParseException, InterruptedException{
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("name", "Not Equals", "change_name", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("name");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","change_name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void changesPagination_NameContains() throws ParseException{
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("name", "Contains", "change_name", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("name");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","change_name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void changesPagination_NameNotContains() throws ParseException{
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("name", "Not Contains", "change_name", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("name");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","change_name",PlutoraAPIConfiguration.testData,"Not Contains");
	    ...
	    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 7)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("priority", "Equals", "change_priority", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("priority");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("priority","change_priority",PlutoraAPIConfiguration.testData,"Equals");
	   ...
	   //priority Not Equals
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 8)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("priority", "Not Equals", "change_priority", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("priority");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("priority","change_priority",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 9)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("priority", "Contains", "change_priority", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("priority");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("priority","change_priority",PlutoraAPIConfiguration.testData,"Contains");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 10)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("priority", "Not Contains", "change_priority", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("priority");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("priority","change_priority",PlutoraAPIConfiguration.testData,"Not Contains");
	    ...
	    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 11)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("status", "Equals", "change_status", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("status");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","change_status",PlutoraAPIConfiguration.testData,"Equals");
	   ...
	   //status Not Equals
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 12)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("status", "Not Equals", "change_status", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("status");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","change_status",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		//status contains 
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("status", "Contains", "change_status", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("status");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","change_status",PlutoraAPIConfiguration.testData,"Contains");
			APIListener.addLogger( "Changes attribute 'status' fetching value for Contains operator successfully!"); 
		}
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 14)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("status", "Not Contains", "change_status", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("status");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("status","change_status",PlutoraAPIConfiguration.testData,"Not Contains");
			APIListener.addLogger( "Changes attribute 'status' fetching value for NotContains operator successfully!"); 
	    ...
	    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 15)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Equals", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Equals");
	   ...
	   //business value score Not Equals
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 16)
			...
			APIListener.addLogger( "[API] - Changes attribute 'status' fetching value for Not Equals operator");
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Not Equals", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void changesPagination_BusinessValueScoreGreaterThan() throws ParseException{
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Greater Than", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Greater Than");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 18)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Greater Or Equal", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Greater Or Equal");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 19)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Less Than", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Less Than");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 20)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("businessValueScore", "Less Or Equal", "change_BVS", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("businessValueScore");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("businessValueScore","change_BVS",PlutoraAPIConfiguration.testData,"Less Or Equal");
	...
	/*
	    ...
	    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 21)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedBy", "Equals", "raised_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("raisedBy");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("raisedBy","raised_By",PlutoraAPIConfiguration.testData,"Equals");
	   ...
	   //raised by Not Equals
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 22)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedBy", "Not Equals", "raised_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("raisedBy");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("raisedBy","raised_By",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		//raised by contains 
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedBy", "Contains", "raised_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("raisedBy");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("raisedBy","raised_By",PlutoraAPIConfiguration.testData,"Contains");
		...
		@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 24)
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedBy", "Not Contains", "raised_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("raisedBy");
			changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("raisedBy","raised_By",PlutoraAPIConfiguration.testData,"Not Contains");
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Equals", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Equals");
		 ...
		 //last Modified date Not equals
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Not Equals", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Not Equals");
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Greater Than", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Than");
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Greater Or Equal", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Less Than", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Than");
		  ...
		  //last Modified date LessOrEqual
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedDate", "Less Or Equal", "split_lastModifiedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			//changesPage.setDataToPropertys("lastModifiedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedDate","split_lastModifiedDate",PlutoraAPIConfiguration.testData,"Less Or Equal");
		  ...
		  //assignedTo Equals 
		    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 31)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedTo", "Equals", "assigned_To", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedTo");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assigned_To",PlutoraAPIConfiguration.testData,"Equals");
		   ...
		   //assignedTo Not Equals
			@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 32)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedTo", "Not Equals", "assigned_To", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedTo");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assigned_To",PlutoraAPIConfiguration.testData,"Not Equals");
			...
			//assignedTo contains 
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedTo", "Contains", "assigned_To", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedTo");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assigned_To",PlutoraAPIConfiguration.testData,"Contains");
			...
			@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 34)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedTo", "Not Contains", "assigned_To", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedTo");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedTo","assigned_To",PlutoraAPIConfiguration.testData,"Not Contains");
		    ...
		    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 35)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedToId", "Equals", "assigned_ToId", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedToId");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedToId","assigned_ToId",PlutoraAPIConfiguration.testData,"Equals");
		   ...
		   //assignedTo Not Equals
			@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 36)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("assignedToId", "Not Equals", "assigned_ToId", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("assignedToId");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("assignedToId","assigned_ToId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		//lastModifiedBy Equals 
		    @Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 37)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedBy", "Equals", "lastModified_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("lastModifiedBy");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","lastModified_By",PlutoraAPIConfiguration.testData,"Equals");
		   ...
		   //lastModifiedBy Not Equals
			@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 38)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedBy", "Not Equals", "lastModified_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("lastModifiedBy");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","lastModified_By",PlutoraAPIConfiguration.testData,"Not Equals");
			...
			//lastModifiedBy contains 
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedBy", "Contains", "lastModified_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("lastModifiedBy");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","lastModified_By",PlutoraAPIConfiguration.testData,"Contains");
			...
			@Test(description = "Pagination and filter Combinations for Changes", groups = { "RegressionTests" },priority = 40)
				...
				APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("lastModifiedBy", "Not Contains", "lastModified_By", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("lastModifiedBy");
				changesPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("lastModifiedBy","lastModified_By",PlutoraAPIConfiguration.testData,"Not Contains");
			...
			APIListener.addLogger("----- With Only filter rule -----");
			changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Equals","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
			changesPage.setDataToPropertysWithoutPage("raisedDate");
			changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Equals");
			...
			public void changesPagination_raisedDateNotEquals() throws ParseException, InterruptedException{
		    	...
		    	APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Not Equals","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("raisedDate");
				changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Not Equals");
			...
			public void changesPagination_raisedDateGreaterThan() throws ParseException, InterruptedException{
		    	...
		    	APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Greater Than","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("raisedDate");
				changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Greater Than");
			...
			public void changesPagination_raisedDateGreaterOrEqual() throws ParseException, InterruptedException{
		    	...
		    	APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Greater Or Equal","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("raisedDate");
				changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Greater Or Equal");
			...
			public void changesPagination_raisedDateLessThan() throws ParseException, InterruptedException{
		    	...
		    	APIListener.addLogger("----- With Only filter rule -----");
					changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Less Than","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
					changesPage.setDataToPropertysWithoutPage("raisedDate");
					changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Less Than");
		  ...
		  //raised LessOrEqual
			...
			public void changesPagination_raisedDateLessOrEqual() throws ParseException, InterruptedException{
		    	APIListener.addLogger( "[API] - Changes attribute 'raised Date' fetching value for Less Than operators"); 
		    	APIListener.addLogger("----- With Only filter rule -----");
				changesPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, changesPage.setPaginationFilterOperator("raisedDate", "Less Or Equal","split_raisedDate", PlutoraAPIConfiguration.testData),"changePaginationFilterUrl");
				changesPage.setDataToPropertysWithoutPage("raisedDate");
				changesPage.verifyDateResponseArrayValueForPaginationWithOnlyFilterRule("raisedDate","split_raisedDate",PlutoraAPIConfiguration.testData,"Less Or Equal");
