...
public class ConnectivityPaginationFilters  {
	...
	EnvironmentPage environmentPage = new EnvironmentPage();
		...
		public void connectivityPagination_IdEquals() throws ParseException, InterruptedException{
			...
			// id Equals
		    APIListener.addLogger( "[API] - Connectivity attribute 'id' fetching value for Equals operastor"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("id", "Equals", "connectivityId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("id");
			environmentPage.verifyResponseArrayValueForPagination("id","connectivityId",PlutoraAPIConfiguration.testData,"Equals");
		  ...
		  public void connectivityPagination_IdNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("id", "Not Equals", "connectivityId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("id");
			environmentPage.verifyResponseArrayValueForPagination("id","connectivityId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupId", "Equals", "environment_GroupId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
		environmentPage.setDataToPropertys("environmentGroupId");
		environmentPage.verifyResponseArrayValueForPagination("environmentGroupId","environment_GroupId",PlutoraAPIConfiguration.testData,"Equals");
		...
		environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupId", "Not Equals", "environment_GroupId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
		environmentPage.setDataToPropertys("environmentGroupId");
		environmentPage.verifyResponseArrayValueForPagination("environmentGroupId","environment_GroupId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_environmentGroupNameEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupName", "Equals", "environment_GroupName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("environmentGroupName");
			environmentPage.verifyResponseArrayValueForPagination("environmentGroupName","environment_GroupName",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_environmentGroupNameNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupName", "Not Equals", "environment_GroupName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("environmentGroupName");
			environmentPage.verifyResponseArrayValueForPagination("environmentGroupName","environment_GroupName",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_environmentGroupNameContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupName", "Contains", "environment_GroupName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("environmentGroupName");
			environmentPage.verifyResponseArrayValueForPagination("environmentGroupName","environment_GroupName",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void connectivityPagination_environmentGroupNameNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("environmentGroupName", "Not Contains", "environment_GroupName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("environmentGroupName");
			environmentPage.verifyResponseArrayValueForPagination("environmentGroupName","environment_GroupName",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void connectivityPagination_sourceIdEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceId", "Equals", "source_Id", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceId");
			environmentPage.verifyResponseArrayValueForPagination("sourceId","source_Id",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_sourceIdNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceId", "Not Equals", "source_Id", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceId");
			environmentPage.verifyResponseArrayValueForPagination("sourceId","source_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_sourceNameEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceName", "Equals", "source_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceName");
			environmentPage.verifyResponseArrayValueForPagination("sourceName","source_Name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_sourceNameNotEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'source Name' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceName", "Not Equals", "source_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceName");
			environmentPage.verifyResponseArrayValueForPagination("sourceName","source_Name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_sourceNameContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'source Name' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceName", "Contains", "source_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceName");
			environmentPage.verifyResponseArrayValueForPagination("sourceName","source_Name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void connectivityPagination_sourceNameNotContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'source Name' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("sourceName", "Not Contains", "source_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("sourceName");
			environmentPage.verifyResponseArrayValueForPagination("sourceName","source_Name",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void connectivityPagination_targetIdEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'source Id' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetId", "Equals", "target_Id", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetId");
			environmentPage.verifyResponseArrayValueForPagination("targetId","target_Id",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_targetIdNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetId", "Not Equals", "target_Id", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetId");
			environmentPage.verifyResponseArrayValueForPagination("targetId","target_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_targetNameEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'source Name' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetName", "Equals", "target_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetName");
			environmentPage.verifyResponseArrayValueForPagination("targetName","target_Name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_targetNameNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetName", "Not Equals", "target_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetName");
			environmentPage.verifyResponseArrayValueForPagination("targetName","target_Name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_targetNameContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'targetName' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetName", "Contains", "target_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetName");
			environmentPage.verifyResponseArrayValueForPagination("targetName","target_Name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void connectivityPagination_targetNameNotContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'targetName' fetching value for Equals operator"); 
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("targetName", "Not Contains", "target_Name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("targetName");
			environmentPage.verifyResponseArrayValueForPagination("targetName","target_Name",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void connectivityPagination_connectivityTypeIdEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeId", "Equals", "connectivity_TypeId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeId");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeId","connectivity_TypeId",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_connectivityTypeIdNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeId", "Not Equals", "connectivity_TypeId", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeId");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeId","connectivity_TypeId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_connectivityTypeNameEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeName", "Equals", "connectivity_TypeName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeName");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeName","connectivity_TypeName",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_connectivityTypeNameNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeName", "Not Equals", "connectivity_TypeName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeName");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeName","connectivity_TypeName",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void connectivityPagination_connectivityTypeNameContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeName", "Contains", "connectivity_TypeName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeName");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeName","connectivity_TypeName",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void connectivityPagination_connectivityTypeNameNotContains() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("connectivityTypeName", "Not Contains", "connectivity_TypeName", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("connectivityTypeName");
			environmentPage.verifyResponseArrayValueForPagination("connectivityTypeName","connectivity_TypeName",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void connectivityPagination_directionEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("direction", "Equals", "direction_name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("direction");
			environmentPage.verifyResponseArrayValueForPagination("direction","direction_name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void connectivityPagination_directionNotEquals() throws ParseException, InterruptedException{
			...
			environmentPage.paginationfilter(PlutoraAPIConfiguration.testData, environmentPage.setPaginationFilterOperator("direction", "Not Equals", "direction_name", PlutoraAPIConfiguration.testData), "0", "10","connectivitiesFilterUrl");
			environmentPage.setDataToPropertys("direction");
			environmentPage.verifyResponseArrayValueForPagination("direction","direction_name",PlutoraAPIConfiguration.testData,"Not Equals");
