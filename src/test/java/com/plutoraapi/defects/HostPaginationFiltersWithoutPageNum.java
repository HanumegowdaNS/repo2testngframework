...
public class HostPaginationFiltersWithoutPageNum {
	...
	public void getHosts_Pagination_IdEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("id", "Equals", "host_Id", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("id");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","host_Id",PlutoraAPIConfiguration.testData,"Equals");
    ...
    public void getHosts_Pagination_IdNotEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("id", "Not Equals", "host_Id", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("id");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","host_Id",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void getHosts_Pagination_nameEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("name", "Equals", "host_name", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("name");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","host_name",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void getHosts_Pagination_nameNotEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("name", "Not Equals", "host_name", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("name");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","host_name",PlutoraAPIConfiguration.testData,"Not Equals");
	...
	public void getHosts_Pagination_NameContains() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("name", "Contains", "host_name", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("name");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","host_name",PlutoraAPIConfiguration.testData,"Contains");
	...
	public void getHosts_Pagination_nameNotContains() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("name", "Not Contains", "host_name", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("name");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","host_name",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	public void getHosts_Pagination_environmentIDEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("environmentID", "Equals", "host_environmentID", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("environmentID");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("environmentID","host_environmentID",PlutoraAPIConfiguration.testData,"Equals");
	...
	public void getHosts_Pagination_environmentIDNotEquals() throws ParseException, InterruptedException {
		...
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterOperator("environmentID", "Not Equals", "host_environmentID", PlutoraAPIConfiguration.testData),"Hosts_PaginationFiltersURL");
		hostPage.setDataToPropertysWithoutPage("environmentID");
		hostPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("environmentID","host_environmentID",PlutoraAPIConfiguration.testData,"Not Equals");
...
/*
	...
	public void GetHosts_Pagination_Name_Combination1() throws ParseException, InterruptedException {
		...
		hostPage.setDataToPropertysWithoutPage("id", "Hosts_Id1");
		hostPage.setDataToPropertysWithoutPage("name", "Name_1");
		hostPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		hostPage.createHosts("createHostsJson", PlutoraAPIConfiguration.testData);
		hostPage.setDataToPropertysWithoutPage("id", "Hosts_Id2");
		hostPage.setDataToPropertysWithoutPage("name", "Name_2");
		hostPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		// Name Equals (a or b)
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterCombinations("name",
	...
	public void GetHosts_Pagination_EnvironmentId_Combination2() throws ParseException, InterruptedException {
		...
		hostPage.createHosts("createHostsJson", PlutoraAPIConfiguration.testData);
		hostPage.setDataToPropertysWithoutPage("id", "Hosts_Id1");
		hostPage.setDataToPropertysWithoutPage("environmentId", "EnvironmentId_1");
		hostPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		hostPage.createHosts("createHostsJson", PlutoraAPIConfiguration.testData);
		hostPage.setDataToPropertysWithoutPage("id", "Hosts_Id2");
		hostPage.setDataToPropertysWithoutPage("environmentId", "EnvironmentId_2");
		hostPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);

		// Environment Id Equals (x or y)
		hostPage.paginationfilterWithoutPagenum(
	...
	public void GetHosts_Pagination_Name_EnvironmentId_CombinationFilters()
		...
		// Name Equals (a or b) and Environment Id Equals (x or y)
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData,
	...
	public void GetHosts_Pagination_Id_Combination1() throws ParseException, InterruptedException {
		...
		// Id Equals (a or b)
		hostPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, hostPage.setPaginationFilterCombinations("id",
