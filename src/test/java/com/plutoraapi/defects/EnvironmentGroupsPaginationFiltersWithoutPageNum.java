...
public class EnvironmentGroupsPaginationFiltersWithoutPageNum  {
	...
	EnvironmentPage environmentPage = new EnvironmentPage();
		...
		public void environmentGroupPagination_IdEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("id", "Equals", "EnvGroup_Id", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("id");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","EnvGroup_Id",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_IdNotEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("id", "Not Equals", "EnvGroup_Id", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("id");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("id","EnvGroup_Id",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_NameEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("name", "Equals", "EnvGroup_name", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("name");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","EnvGroup_name",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_NameNotEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("name", "Not Equals", "EnvGroup_name", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("name");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","EnvGroup_name",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_NameContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("name", "Contains", "EnvGroup_name", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("name");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","EnvGroup_name",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_NameNotContains() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'name' fetching value for Equals operator");
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("name", "Not Contains", "EnvGroup_name", PlutoraAPIConfiguration.testData), "changePaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("name");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("name","EnvGroup_name",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentGroupPagination_descriptionEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("description", "Equals", "EnvGroup_description", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("description");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","EnvGroup_description",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_descriptionNotEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("description", "Not Equals", "EnvGroup_description", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("description");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","EnvGroup_description",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_descriptionContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("description", "Contains", "EnvGroup_description", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("description");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","EnvGroup_description",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_descriptionNotContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("description", "Not Contains", "EnvGroup_description", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("description");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("description","EnvGroup_description",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentGroupPagination_colorEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("color", "Equals", "Group_color", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("color");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Group_color",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_colorNotEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("color", "Not Equals", "Group_color", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("color");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Group_color",PlutoraAPIConfiguration.testData,"Not Equals");
	 ...
	 //color contains
		...
		public void environmentGroupPagination_colorContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("color", "Contains", "Group_color", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("color");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Group_color",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_colorNotContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("color", "Not Contains", "Group_color", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("color");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("color","Group_color",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentGroupPagination_usageWorkItemIdEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemId", "Equals", "EnvGroup_usageWorkItemId", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("usageWorkItemId");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemId","EnvGroup_usageWorkItemId",PlutoraAPIConfiguration.testData,"Equals");
		...
		APIListener.addLogger( "[API] - Environment Groups attribute 'usageWorkItemId' fetching value for not equals operator");
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemId", "Not Equals", "EnvGroup_usageWorkItemId", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("usageWorkItemId");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemId","EnvGroup_usageWorkItemId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_usageWorkItemNameEquals() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemName", "Equals", "EnvGroup_usageWorkItemName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("usageWorkItemName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemName","EnvGroup_usageWorkItemName",PlutoraAPIConfiguration.testData,"Equals");
		...
		APIListener.addLogger( "[API] - Environment Groups attribute 'usageWorkItemName' fetching value for equals operator");
		   environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemName", "Not Equals", "EnvGroup_usageWorkItemName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
		   environmentGroupsPage.setDataToProperty("usageWorkItemName");
		   environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemName","EnvGroup_usageWorkItemName",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_usageWorkItemNameContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemName", "Contains", "EnvGroup_usageWorkItemName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("usageWorkItemName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemName","EnvGroup_usageWorkItemName",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_usageWorkItemNameNotContains() throws ParseException, InterruptedException{
			...
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("usageWorkItemName", "Not Contains", "EnvGroup_usageWorkItemName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("usageWorkItemName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("usageWorkItemName","EnvGroup_usageWorkItemName",PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentGroupPagination_organizationIdEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationId", "Equals", "EnvGroup_organizationId", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("organizationId");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationId","EnvGroup_organizationId",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_organizationIdNotEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationId", "Not Equals", "EnvGroup_organizationId", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("organizationId");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationId","EnvGroup_organizationId",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_organizationNameEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationName", "Equals", "EnvGroup_organizationName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("organizationName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationName","EnvGroup_organizationName",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_organizationNameNotEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationName", "Not Equals", "EnvGroup_organizationName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("organizationName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationName","EnvGroup_organizationName",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_organizationNameContains() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationName", "Contains", "EnvGroup_organizationName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("organizationName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationName","EnvGroup_organizationName",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_organizationNameNotContains() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("organizationName", "Not Contains", "EnvGroup_organizationName", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("organizationName");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("organizationName","EnvGroup_organizationName",PlutoraAPIConfiguration.testData,"Not Contains");
	...
	/*	
		...
		public void environmentGroupPagination_environmentIDsContains() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("environmentIDs", "Contains", arrayString[0], PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("environmentIDs","EnvGroup_environmentIDs");
			arrayString = environmentGroupsPage.addStringToArray(PropertiesCache.getProperty(PlutoraAPIConfiguration.testData,"EnvGroup_environmentIDs"));
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("environmentIDs",arrayString[0],PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_environmentIDsNotContains() throws ParseException, InterruptedException{
			...
			arrayString = environmentGroupsPage.addStringToArray(PropertiesCache.getProperty(PlutoraAPIConfiguration.testData,"EnvGroup_environmentIDs"));
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("environmentIDs", "Not Contains", arrayString[0], PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("environmentIDs");
			arrayString = environmentGroupsPage.addStringToArray(PropertiesCache.getProperty(PlutoraAPIConfiguration.testData,"EnvGroup_environmentIDs"));
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("environmentIDs",arrayString[0],PlutoraAPIConfiguration.testData,"Not Contains");
		...
		public void environmentGroupPagination_isAutoApprovedEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("isAutoApproved", "Equals","EnvGroup_isAutoApproved", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("isAutoApproved");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("isAutoApproved","EnvGroup_isAutoApproved",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_isAutoApprovedNotEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("isAutoApproved", "Not Equals","EnvGroup_isAutoApproved", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("isAutoApproved");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("isAutoApproved","EnvGroup_isAutoApproved",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_displayBookingAlertEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("displayBookingAlert", "Equals","EnvGroup_displayBookingAlert", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("displayBookingAlert");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayBookingAlert","EnvGroup_displayBookingAlert",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_displayBookingAlertNotEquals() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("displayBookingAlert", "Not Equals","EnvGroup_displayBookingAlert", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("displayBookingAlert");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("displayBookingAlert","EnvGroup_displayBookingAlert",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_bookingAlertMessageEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'displayBookingAlert' fetching value for equals operator");
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("bookingAlertMessage", "Equals","EnvGroup_bookingAlertMessage", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("bookingAlertMessage");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("bookingAlertMessage","EnvGroup_bookingAlertMessage",PlutoraAPIConfiguration.testData,"Equals");
		...
		public void environmentGroupPagination_bookingAlertMessageNotEquals() throws ParseException, InterruptedException{
			APIListener.addLogger( "[API] - Environment Groups attribute 'displayBookingAlert' fetching value for equals operator");
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("bookingAlertMessage", "Not Equals","EnvGroup_bookingAlertMessage", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToPropertysWithoutPage("bookingAlertMessage");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("bookingAlertMessage","EnvGroup_bookingAlertMessage",PlutoraAPIConfiguration.testData,"Not Equals");
		...
		public void environmentGroupPagination_bookingAlertMessageContains() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("bookingAlertMessage", "Contains","EnvGroup_bookingAlertMessage", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("bookingAlertMessage");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("bookingAlertMessage","EnvGroup_bookingAlertMessage",PlutoraAPIConfiguration.testData,"Contains");
		...
		public void environmentGroupPagination_bookingAlertMessageNotContains() throws ParseException, InterruptedException{
		    ...
		    environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterOperator("bookingAlertMessage", "Not Contains","EnvGroup_bookingAlertMessage", PlutoraAPIConfiguration.testData), "envGroupPaginationFilterUrl");
			environmentGroupsPage.setDataToProperty("bookingAlertMessage");
			environmentGroupsPage.verifyResponseArrayValueForPaginationWithOnlyFilterRule("bookingAlertMessage","EnvGroup_bookingAlertMessage",PlutoraAPIConfiguration.testData,"Not Contains");
...
/*	
		...
		public void environmentGroupPagination_Combinations1() throws ParseException, InterruptedException{
			...
			//create system
			systemsPage.createSystems("createSystemsJson", PlutoraAPIConfiguration.testData);
			systemsPage.setDataToPropertysWithoutPage("id","System_Id"); 
			APIListener.addLogger( "System has been created successfully! ");
			...
			environmentPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
			APIListener.addLogger( "Environment has been created successfully! ");
			environmentPage.setDataToPropertysWithoutPage("id", "Environment_ID");
			
			// create environment groups
			environmentGroupsPage.createEnvironmentGroupWithEnv("CreateEnvironmentGroup4516Json", PlutoraAPIConfiguration.testData, "Environment_ID");
			environmentGroupsPage.setDataToPropertysWithoutPage("id", "EnvGroup_Id");
			environmentGroupsPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
			APIListener.addLogger( "Environment group has been created successfully! ");
			environmentGroupsPage.setDataToPropertysWithoutPage("name;usageWorkIteamName;isAutoApproved;organizationName","name_1;usageIteam_1;isAutoApproved_1;orgName_1");
			environmentGroupsPage.setDataToPropertysWithoutPage("environmentIDs;color;displayBookingAlert;bookingAlertMessage" ,"envId_1;color_1;displayBook_1;bookingAlertMsg_1");
			
			//create another environment group
			//create system
			systemsPage.createSystems("createSystemsJson", PlutoraAPIConfiguration.testData);
			systemsPage.setDataToPropertysWithoutPage("id","System_Id1"); 
			APIListener.addLogger( "System has been created successfully! ");
			...
			environmentPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
			APIListener.addLogger( "Environment has been created successfully! ");
			environmentPage.setDataToPropertysWithoutPage("id", "Environment_ID1");
			...
			environmentGroupsPage.setDataToPropertysWithoutPage("id", "EnvGroup_Id1");
			environmentGroupsPage.verifyStatusCode("CREATED_Status_Code", PlutoraAPIConfiguration.testData);
			APIListener.addLogger( "Environment group has been created successfully! ");
			environmentGroupsPage.setDataToPropertysWithoutPage("name;usageWorkIteamName;isAutoApproved;organizationName","name_2;usageIteam_2;isAutoApproved_2;orgName_2");
			environmentGroupsPage.setDataToPropertysWithoutPage("environmentIDs;color;displayBookingAlert;bookingAlertMessage" ,"envId_2;color_2;displayBook_2;bookingAlertMsg_2");

			//usageWorkItemName contains(a or b) and  organizationName equals (x or y)
			environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterCombinations_1("usageWorkItemName", "Contains", "usageIteam_1","OR","usageIteam_2", "And","organizationName", "Equals","orgName_1", "Or", "orgName_2",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
		...
		environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterCombinations_1("environmentIDs", "Equals", "envId_1","OR","envId_2", "Or","usageWorkItemName", "NotEquals","usageIteam_1", "Or", "usageIteam_1",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
		...
		environmentGroupsPage.paginationfilterWithoutPagenum(PlutoraAPIConfiguration.testData, environmentGroupsPage.setPaginationFilterCombinations_1("name", "Contains", "name_1","OR","name_2", "And","color", "Equals","color_1", "Or", "color_2",PlutoraAPIConfiguration.testData), "1", "10","changePaginationFilterUrl");
